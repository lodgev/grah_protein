...
#         if data:
#             # Save search result to session_state
#             st.session_state.last_search_data = data
#             st.session_state.search_performed = True

#             # Save initial nodes & edges
#             nodes = []
#             edges = []
...
#         # --- FILTERS ---
#         st.subheader("Graph Display Options:")
#         show_direct = st.checkbox("Show Direct Neighbors", value=True)
#         show_second = st.checkbox("Show Second-Level Neighbors", value=True)

#         # --- Apply filters ---
#         filtered_nodes = []
#         filtered_edges = []

#         # Always show main protein
...
#         # Overwrite session_state only ONCE (after first search)
#         if 'current_nodes' not in st.session_state:
#             st.session_state.current_nodes = filtered_nodes.copy()
#             st.session_state.current_edges = filtered_edges.copy()
...
#             # Перезавантажуємо сторінку для оновлення графа
